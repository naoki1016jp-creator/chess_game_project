...
public static class ChessRules
{
                ...
                switch (piece.pieceType)
                {
                    ...
                    case PieceType.King:
                    {
                        ...
                        for (int dy = -1; dy <= 1; dy++)
                        {
                            ...
                            if (square == new Vector2Int(x + dx, y + dy)) return true;
                        }
                        break;
                    }
                }
    ...
    public static bool CanCastleKingSide(Piece[,] board, King king)
    {
        ...
        Piece rookPiece1 = board[7, y];
        if (rookPiece1 == null || rookPiece1.pieceType != PieceType.Rook ||
            rookPiece1.color != king.color || rookPiece1.hasMoved) return false;

        if (board[5, y] != null || board[6, y] != null) return false;
    ...
    public static bool CanCastleQueenSide(Piece[,] board, King king)
    {
        ...
        Piece rookPiece2 = board[0, y];
        if (rookPiece2 == null || rookPiece2.pieceType != PieceType.Rook ||
            rookPiece2.color != king.color || rookPiece2.hasMoved) return false;

        if (board[1, y] != null || board[2, y] != null || board[3, y] != null) return false;
